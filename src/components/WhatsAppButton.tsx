...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({ phoneNumber = '2349137487240' }) => {
  ...
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi! I'm interested in DijuTech Solutions smart home products. Can you help me get a quote?");
